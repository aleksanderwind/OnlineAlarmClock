...
void setup()
{
  ...
  server.on("/DHT", HTTP_POST, handleDHT);
...
void handleDHT()
{
  ...
  for (int i = 0; i < 5; i++)
  {
    tmpTF = htSens.smoothTempDHT();
    tmpHF = htSens.smoothHumiDHT();
    delay(200);
  }
  ...
  /*Debugging
  Serial.print("Temp ws: ");
  Serial.print(tmpTF);
  Serial.print("; temp new: ");
  Serial.println(htSens.smoothTempDHT());
  Serial.print("Humi ws: ");
  Serial.print(tmpHF);
  Serial.print("; humi new: ");
  */
  Serial.println(htSens.smoothHumiDHT());  
  char str[512];
  sprintf(str,"<html><head><title>Temperature & Humidity Information</title><meta charset=\"utf-8\" \/> \</head><body><h1>DHT:</h1> \<p>Temperature: %s°C</p>\<p>Humidity: %s%%</p>\<img src=\"https://s.keepmeme.com/files/en_posts/20200821/8351b090ed397871c315c13555d7bc7athermometer-displays-poor.jpg\">\</body></html>", tmpT,tmpH);
